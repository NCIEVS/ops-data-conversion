...
class Study extends OIDEntity {
  var globalVarsStudyName: String = null
  var globalVarsStudyDescription: String = null
  var globalVarsStudyProtocolName: String = null
  val munits = new ArrayBuffer[MeasurementUnit]() 
  val mdvs = new ArrayBuffer[MDV]()
}
