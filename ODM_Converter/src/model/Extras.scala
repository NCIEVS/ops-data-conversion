...
trait Extras {
  val extras = new HashMap[String,String]()
  
  val extendedAttributes = new ArrayBuffer[Extension]()
  val extendedElements = new ArrayBuffer[Extension]()
  
  def addExtra(key: String, value: String) {
      if (value != null) {
          extras(key) = value
      }
  }
