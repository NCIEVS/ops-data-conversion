...
class CodeList(var name : String, var datatype: String) extends Extras with OIDEntity {
  
  var description : String = null
  val codelistItems = new ArrayBuffer[CodeListItem]()
  val enumeratedItems = new ArrayBuffer[EnumeratedItem]()
  
  def this(oid: String, name : String, datatype: String) = {
    this(name, datatype)
    this.oid = oid
  }
  
  override def toString() = "Codelist[" + oid + ", name=" + name + "]"
}
