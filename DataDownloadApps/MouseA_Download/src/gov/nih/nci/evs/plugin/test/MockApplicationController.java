...
import gov.nih.nci.evs.plugin.download.MouseDownloadPlugin;
...
public class MockApplicationController {
    ...
    private void testDownload(){
        MouseDownloadPlugin plugin = new MouseDownloadPlugin();
...
//        MouseLoadPlugin plugin = new MouseLoadPlugin();
//        plugin.setAuxilliaryPath(auxPath);
//        plugin.setLogger(LOGGER);
//        if (inputFile!= null && inputFile.length()>0){
//            plugin.setInputFile(inputFile);
